...
class Player extends Unit{
	...
	public Player(User user) {
		this.user = user;
		int playerHP = this.user.currentplane.HP;
		...
		if(this.user.currentplane.name == "F4K")
			this.img = tk.getImage("src/main/SOURCE/F4K.png");
		
		else if(this.user.currentplane.name == "F15K")
			this.img = tk.getImage("src/main/SOURCE/F15K.png");
		
		else if(this.user.currentplane.name == "F35K")
...
// enemyplane (제일 standardenemy인 앞으로 전진하는 plane)
